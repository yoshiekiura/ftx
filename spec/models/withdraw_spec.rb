...
describe Withdraw do
  ...
  #       pending
  #       # TODO: CHECK validates :amount, numericality: {greater_than: 0}
  ...
  #     StratumAddress.stubs( :send_to_address).returns([operation_etxid: 1])
  #     StratumAddress.stubs(:save_withdraw).returns(nil)
  #     Currency.any_instance.stubs(:balance).returns(999999)
  #
  ...
  #       pending
  #       # TODO: again the lock problem inside "audit!"
  #
  #       subject.update_attributes sum: 1.to_d
  #       subject.audit!
