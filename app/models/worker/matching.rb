module Worker
  ...
  class Matching
    ...
    def on_usr2
     ...
     add_transaction_tracer :submit, :category => :task
     add_transaction_tracer :cancel, :category => :task
     add_transaction_tracer :reload, :category => :task
     add_transaction_tracer :build_order, :category => :task
     add_transaction_tracer :initialize_engine, :category => :task
     add_transaction_tracer :create_engine, :category => :task
     add_transaction_tracer :load_orders, :category => :task
     add_transaction_tracer :start_engine, :category => :task
     add_transaction_tracer :on_usr1, :category => :task
     add_transaction_tracer :on_usr2, :category => :task
  end
end
