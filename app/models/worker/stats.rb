module Worker
  ...
  class Stats
    ...
    def get_point(ts, period)
     ...
     add_transaction_tracer :collect, :category => :task
     add_transaction_tracer :next_point, :category => :task
     add_transaction_tracer :point_1_set, :category => :task
     add_transaction_tracer :get_point, :category => :task
  end
end
