...
class PaymentAddress < ActiveRecord::Base
  ...
  def deposit_address
    unless address.nil?
      if  address.include?("bitcoincash:")
        currency_obj[:deposit_account] || address.gsub(/bitcoincash:/, "")
      else
  ...
  class << self
    ...
    #                         :name => "PaymentAddress/as_json" ,
    #                         :category => :task
    # add_transaction_tracer  :trigger_deposit_address,
    #                         :name => "PaymentAddress/trigger_deposit_address" ,
    #                         :category => :task
    # add_transaction_tracer  :construct_memo,
    #                         :name => "PaymentAddress/construct_memo" ,
    #                         :category => :task
    # add_transaction_tracer  :destruct_memo,
    #                         :name => "PaymentAddress/destruct_memo" ,
    #                         :category => :task
    # add_transaction_tracer  :deposit_address,
    #                         :name => "PaymentAddress/deposit_address" ,
    #                         :category => :task
