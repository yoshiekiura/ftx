class Account < ActiveRecord::Base
  ...
  STRIKE_FEE_WITHDRAW = :strike_fee_withdraw
  ...
  class StratumError < AccountError; end
  ...
  def sync_update
   ...
   # add_transaction_tracer :payment_address,
   #                        :name => 'payment_address',
   #                        :category => "Account/payment_address"
   # add_transaction_tracer :plus_funds,
   #                        :name => 'plus_funds',
   #                        :category => "Account/plus_funds"
   # add_transaction_tracer :sub_funds,
   #                        :name => 'sub_funds',
   #                        :category => "Account/sub_funds"
   # add_transaction_tracer :lock_funds,
   #                       :name => 'lock_funds',
   #                       :category => "Account/lock_funds"
   # add_transaction_tracer :unlock_funds,
   #                       :name => 'unlock_funds',
   #                       :category => "Account/unlock_funds"
   # add_transaction_tracer :unlock_and_sub_funds,
   #                       :name => 'unlock_and_sub_funds',
   #                       :category => "Account/unlock_and_sub_funds"
   # add_transaction_tracer :amount,
   #                       :name => 'amount',
   #                       :category => "Account/amount"
   # add_transaction_tracer :last_version,
   #                       :name => 'last_version',
   #                       :category => "Account/last_version"
   # add_transaction_tracer :examine,
   #                       :name => 'examine',
   #                       :category => "Account/examine"
   # add_transaction_tracer :trigger,
   #                       :name => 'trigger',
   #                       :category => "Account/trigger"
   # add_transaction_tracer :sync_update,
   #                       :name => 'sync_update',
   #                       :category => "Account/sync_update"
