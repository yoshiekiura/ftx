@OrderV2BookUI = flight.component ->
  @attributes
    bookLimit: 30
  ...
  @updateOrders = (table, orders, bid_or_ask) ->
    ...
    @mergeUpdate bid_or_ask, book, orders, JST["templates/order_book_v2_#{bid_or_ask}"]
  ...
  @after 'initialize', ->
    @on document, 'market::order_book::update::all', @update
