...
$ ->
  ...
  HeaderUI.attachTo('.top-bar')
  AccountSummaryUI.attachTo('#account_summary')
  AccountBalanceUI.attachTo('#mybalance')
  ...
  OrderBookUI.attachTo('#orderbook')
  DepthUI.attachTo('#depths_wrapper')
  MyOrdersUI.attachTo('#tb-orders')
  MyOrdersV2UI.attachTo('#tb-orders')

  MarketTickerUI.attachTo('#ticker')

  MarketV2TickerUI.attachTo('#bid_entry')
  MarketV2TickerUI.attachTo('#ask_entry')


  MarketSwitchUI.attachTo('#market_list_wrapper')
  MarketListTickersUI.attachTo('#ticker2')
  ...
  CandlestickTVUI.attachTo('#candlestick_tv')
