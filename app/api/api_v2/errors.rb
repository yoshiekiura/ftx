module APIv2
  ...
  class EventByOperationIdNotFoundError < Error
    def initialize(id)
      super code: 2012, text: "Event##operation_id=#{id} doesn't exist.", status: 404
    end
  end

  class UpdateStratumEventError < Error
    def initialize(e)
      super code: 2003, text: "Failed to update Stratum event. Reason: #{e}", status: 400
    end
  end
