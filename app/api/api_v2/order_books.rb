module APIv2
  ...
  class OrderBooks < Grape::API
    ...
    params do
      ...
      optional :asks_limit, type: Integer
#, default: 20, range: 1..200, desc: 'Limit the number of returned sell orders. Default to 20.'
      optional :bids_limit, type: Integer
#, default: 20, range: 1..200, desc: 'Limit the number of returned buy orders. Default to 20.'
    end
    get "/order_book" do
