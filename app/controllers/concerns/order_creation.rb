  ...
  module OrderCreation
    ...
    def order_params(order)
      ...
      params.require(order).permit(
        ...
        :state, :origin_volume, :volume, :member_id, :ord_type, :last_bid, :total, :volume_holder)
    end

    def order_submit
      
      begin
        Ordering.new(@order, @market).submit
    ...
    def success_result
      Jbuilder.encode do |json|
        json.result true
        json.message I18n.t("private.markets.show.success_mensagem")
      end
    end
