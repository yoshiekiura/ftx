class RenameStratumOperationsToEvents2 < ActiveRecord::Migration
  def self.up
  ...
  def self.down
	...
	add_index :stratum_events, :stratum_id
	add_index :stratum_events, :eid
	add_index :stratum_events, :receive_at
	add_index :stratum_events, :wallet_eid
	add_index :stratum_events, :currency
	add_index :stratum_events, :operation
	add_index :stratum_events, :etxid
	add_index :stratum_events, :stratum_state
	add_index :stratum_events, :state
  end 
